 ...
 */
@Entity
@Table(name = "MW_ASOC_PRD_REL")
//@IdClass(MwAsocPrdRelId.class)

public class MwAsocPrdRel implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @Column(name = "ASOC_PRD_REL_SEQ")
    private Long asocPrdRelSeq;

    @Column(name = "PRD_SEQ")
    private Long prdSeq;

    @Column(name = "ASOC_PRD_SEQ")
