...
@Entity
@Table(name = "mw_biz_acty")
//@IdClass(MwBizActyId.class)
public class MwBizActy implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @Column(name = "BIZ_ACTY_SEQ")
    private Long bizActySeq;

    @Column(name = "biz_acty_id")
    private String bizActyId;

    @Column(name = "biz_acty_nm")
    private String bizActyNm;

    @Column(name = "biz_sect_seq")
    private Long bizSectSeq;

    @Column(name = "biz_acty_sts_Key")
    private Long bizActyStsKey;

    @Column(name = "biz_Acty_Sort_Ordr")
